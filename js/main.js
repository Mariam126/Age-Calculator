...
// }
// another function for calculating age
 button.onclick= function calculateAge() {
    ...
    // Display the result
    result.innerHTML =`Age: <span>${age.years}</span>  years, <span>${age.months}</span>  months and <span>${age.days}</span> days `;
}
...
function calculateAgeFromBirthdate(birthdate) {
    ...
    var ageInMilliseconds = currentDate - birthdateObject;
